    ...
    <div
      ...
      <div class="hero-content text-neutral-content text-center">
        <div class="max-w-xl">
          ...
          <h1 class="mb-10 text-left text-2xl text-white font-bold">Los Inicios<h1>

          <p class="mb-7 text-sm font-semibold text-gray-100">
          ...
          <h1 class="mb-10 text-left text-2xl text-white font-bold">El Crecimiento<h1>
            ...
            <h1 class="mb-10 text-left text-2xl text-white font-bold">La Innovación<h1>
                ...
                <h1 class="mb-10 text-left text-2xl text-white font-bold">La Comunidad Hyper<h1>
                ...
                <h1 class="mb-10 text-left text-2xl text-white font-bold">El Legado<h1>
